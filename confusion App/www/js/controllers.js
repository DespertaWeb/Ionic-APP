angular.module('conFusion.controllers', [])
  ...
  .controller('MenuController', ['$scope', '$localStorage','menuFactory', 'favoriteFactory', 'baseURL', '$ionicListDelegate','dishes', function($scope,$localStorage, menuFactory, favoriteFactory, baseURL, $ionicListDelegate, dishes) {
    ...
    $scope.dishes = dishes;
    $scope.dishData = $localStorage.getObject('favs','{}');
...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'baseURL', '$ionicPopover', 'favoriteFactory','$ionicModal','$localStorage', function($scope, $stateParams, dish, menuFactory, baseURL, $ionicPopover, favoriteFactory,$ionicModal, $localStorage) {
...
.controller('AboutController', ['$scope', 'corporateFactory','leadership', function($scope, corporateFactory,leadership ) {
  ...
  .controller('FavoritesController', ['$scope', 'dishes','favorites', 'favoriteFactory', 'baseURL', '$ionicListDelegate', '$ionicPopup', '$ionicLoading', '$timeout','$localStorage', function($scope, dishes, favorites,favoriteFactory, baseURL, $ionicListDelegate, $ionicPopup, $ionicLoading, $timeout, $localStorage) {
      // We still need favoriteFactory 'cause of the deletion of favorites
